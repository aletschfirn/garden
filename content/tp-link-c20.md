...
Archer C20 is a basic router w/o USB and with low storage and OpenWRT support (needs to be installed with TFTP. Just set TFTP server IP to 192.168.0.66 and leave tp_recovery.bin in server's root folder, then hold reset and restart your router. Voila!)
...
This router is more than good for basic usage like PPPoE connection and Wireless AP. (plus DoH, and, maybe, OpenVPN connection over tun-interface?)
